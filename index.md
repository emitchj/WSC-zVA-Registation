...
The server XML configuration files referenced in the exercises can be downloaded from [here]([here](https://github.com/ibm-wsc/zCONNEE-Wildfire-Workshop/tree/master/XML%20Samples) to view them locally.
